...
// 图片质量
let WAUpdateImageQualityNotification = NSNotification.Name.init(rawValue: "wa.updateImageQualityNotification")
// 清理缓存
let WACleanCacheNotification = NSNotification.Name.init(rawValue: "wa.cleanCacheNotification")
// 开机自启
let WAStartUpNotification = NSNotification.Name.init(rawValue: "wa.startUpNotification")
